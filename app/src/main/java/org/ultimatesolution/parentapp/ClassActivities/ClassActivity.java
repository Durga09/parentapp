...
public class ClassActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v1 = findViewById(R.id.btn_classLeave);
        v1.setOnClickListener((View.OnClickListener) this);

        View v3 = findViewById(R.id.btn_ClassTimeTable);
        v3.setOnClickListener((View.OnClickListener) this);

        View v2 = findViewById(R.id.btn_classLeaveStatus);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_classLeave) {
            Intent intent = new Intent(this, ClassLeave.class);
            this.startActivity(intent);
        }

        if (v.getId() == R.id.btn_ClassTimeTable) {
            Intent intent = new Intent(this, ClassTimeTable.class);
            this.startActivity(intent);
        }

        if (v.getId() == R.id.btn_classLeaveStatus) {
            Intent intent = new Intent(this, ClassLeaveStatus.class);
            this.startActivity(intent);
        }
    }
}
